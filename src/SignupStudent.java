...
public class SignupStudent extends JFrame {
	...
	public SignupStudent() {
	 ...
	 void register() {
		...
		try {
			...
			String query = "INSERT INTO studentsignup(Name,Email,Username,Password,Age,Contact,Gender) VALUES(?,?,?,?,?,?,?)";
	...
	private void design() {
		...
		rdbtnFemale.setBounds(197, 230, 109, 23);
		buttonGroup.add(rdbtnFemale);
		getContentPane().add(rdbtnFemale);

		JButton btnResigter = new JButton("Register");
		btnResigter.setBounds(302, 304, 118, 23);
		...
		chckbxIAcceptAll.setBounds(48, 304, 248, 23);
		...
		btnBack.setBounds(260, 370, 89, 23);
